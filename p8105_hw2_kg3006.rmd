...
##### State_name and state 
First looking at state_name and state. Not needed since merge will be based on zip_code
```{r}
table(zori$state_name) # all NY as character 
#Missing values
any(is.na(zori$state_name)) # No missing values
table(zori$state) # all NY
#Removing state_name and state 
zori <- zori %>%
